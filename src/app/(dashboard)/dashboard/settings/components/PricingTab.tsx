  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-16">
        <div className="text-text-muted animate-pulse">Loading pricing data...</div>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-3 text-sm">
          <div className="bg-bg-subtle rounded-lg px-3 py-2 text-center">
            <div className="text-text-muted text-xs font-semibold">Providers</div>
            <div className="text-lg font-bold">{stats.providers}</div>
          </div>
          <div className="bg-bg-subtle rounded-lg px-3 py-2 text-center">
            <div className="text-text-muted text-xs font-semibold">Registry</div>
      ...
      <div className="flex flex-col gap-2">
        ...
        {displayProviders.length === 0 && (
          <div className="text-center py-12 text-text-muted">No providers match your search.</div>
        )}
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          {isEdited && <span className="text-yellow-500 text-xs font-medium">unsaved</span>}
